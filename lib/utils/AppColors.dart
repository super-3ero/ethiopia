...
class AppColors {
  ...
  static const Color grey = Color(0xFFDBDCE6);
  static const Color indigo = Color(0xFF6C79DB);
  static const Color lightBlue = Color(0xFF7886E9);
  ...
  static const Color yellow = Color(0xFFFFCA45);
  static const Color violet = Color(0xFF9C5BF5);
